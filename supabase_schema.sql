...
CREATE TABLE IF NOT EXISTS pericias (
  ...
  parte_requerente TEXT NOT NULL,
  parte_requerida TEXT NOT NULL,
  perito_nome TEXT NOT NULL,
  perito_especialidade TEXT NOT NULL,
  data_nomeacao DATE NOT NULL,
  data_pericia DATE NOT NULL,
  objetivo TEXT NOT NULL,
  local_inspecionado TEXT NOT NULL,
  setor TEXT,
